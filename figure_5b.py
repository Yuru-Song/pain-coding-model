...
sio.savemat(data_path + '/figure_5b1.mat',{'sum_u':sum_u,'sum_v':sum_v,'z_init':z_init,'Pi_2':Pi_2})	
...
sio.savemat(data_path + '/figure_5b2.mat',{'sum_u':sum_u,'sum_v':sum_v,'z_init':z_init,'Pi_2':Pi_2})	
