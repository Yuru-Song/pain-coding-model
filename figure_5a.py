...
'''
Figure 5A left, evoked, change Pi_1 = Pi_3 , while Pi_2 = 1
'''
...
sio.savemat(data_path + 'figure_5a1.mat',{'sum_u':sum_u,'sum_v':sum_v,'evkd_amp':evkd_amp,'Pi_2':Pi_2})	
...
sio.savemat(data_path +'figure_5a2.mat',{'sum_u':sum_u,'sum_v':sum_v,'z_init':z_init,'Pi_2':Pi_2})	
